...
{{-- <div class="form-group {{ $errors->has('randomize_sequence') ? 'has-error' : ''}}">
    ...
    <div class="radio"> --}}
<input name="randomize_sequence" type="hidden" value="1" {{ (isset($quizanswer) && 1 == $quizanswer->randomize_sequence) ? 'checked' : '' }}/>
{{-- </div>
<div class="radio"> --}}
...
<input class="form-control" name="quiz_id" type="hidden" id="quiz_id" value="{{ isset($quizanswer->quiz_id) ? $quizanswer->quiz_id : $quiz_id}}" >
