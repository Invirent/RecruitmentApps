            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/quizzes/' . $quiz->id . '/edit') }}" title="Edit Quiz"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Sequence </th><td> {{ $quiz->sequence }} </td></tr><tr><th> Question </th><td> {{ $quiz->question }} </td></tr><tr><th> Required </th><td> {{ $quiz->required }} </td></tr>
                                </tbody>
                            </table>
                        </div>
