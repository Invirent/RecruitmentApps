...
@section('container')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">QuizTemplate {{ $quiztemplate->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $quiztemplate->id }}</td>
                                    </tr>
                                    <tr><th> Name </th><td> {{ $quiztemplate->name }} </td></tr><tr><th> Description </th><td> {{ $quiztemplate->description }} </td></tr>
                                </tbody>
                            </table>
                        </div>
